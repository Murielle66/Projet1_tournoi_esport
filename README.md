...
1. INTRODUCTION 
Ce projet consiste à créer une application en python capable de gérer un tournoi de jeux de A à Z. L'idée est de passer d'une gestion manuelle (souvent compliquée ) à une automatisation complète des matchs et des scores via un programme en ligne de commande.
